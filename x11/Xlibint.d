...
alias FreeFuncType = void function(
    Display*                                            /* display                                                      */
);

alias FreeModmapType = int function(
...
alias _XFreeFuncRec = _XFreeFuncs;
                                                        ...
                                                        /* types for InitExt.c                                          */
alias CreateGCType = int function (
    Display*                                            /* display                                                      */,
    GC                                                  /* gc                                                           */,
    XExtCodes*                                          /* codes                                                        */
);

alias CopyGCType = int function(
    Display*                                            /* display                                                      */,
    GC                                                  /* gc                                                           */,
    XExtCodes*                                          /* codes                                                        */
);

alias FlushGCType = int function (
    Display*                                            /* display                                                      */,
    GC                                                  /* gc                                                           */,
    XExtCodes*                                          /* codes                                                        */
);

alias FreeGCType = int function (
    Display*                                            /* display                                                      */,
    GC                                                  /* gc                                                           */,
    XExtCodes*                                          /* codes                                                        */
);

alias CreateFontType = int function (
    Display*                                            /* display                                                      */,
    XFontStruct*                                        /* fs                                                           */,
    XExtCodes*                                          /* codes                                                        */
);

alias FreeFontType = int function(
    Display*                                            /* display                                                      */,
    XFontStruct*                                        /* fs                                                           */,
    XExtCodes*                                          /* codes                                                        */
);

alias CloseDisplayType = int function(
    Display*                                            /* display                                                      */,
    XExtCodes*                                          /* codes                                                        */
);

alias ErrorType = int function(
    Display*                                            /* display                                                      */,
    xError*                                             /* err                                                          */,
    XExtCodes*                                          /* codes                                                        */,
    int*                                                /* ret_code                                                     */
...
alias ErrorStringType = char* function(
    Display*                                            /* display                                                      */,
    int                                                 /* code                                                         */,
    XExtCodes*                                          /* codes                                                        */,
    char*                                               /* buffer                                                       */,
...
alias PrintErrorType = void function(
    Display*                                            /* display                                                      */,
    XErrorEvent*                                        /* ev                                                           */,
    void*                                               /* fp                                                           */
);

alias BeforeFlushType = void function(
    Display*                                            /* display                                                      */,
    XExtCodes*                                          /* codes                                                        */,
    const char*                                         /* data                                                         */,
    c_long                                               /* len                                                          */
...
alias _XInternalConnectionProc = void function(
    Display*                                            /* dpy                                                          */,
    int                                                 /* fd                                                           */,
    XPointer                                            /* call_data                                                    */
);
