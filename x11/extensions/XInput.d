...
void FindTypeAndClass(A,B,C,D,E)(ref A d, ref B type, ref C _class, D classid, E offset){
    int _i;
    XInputClassInfo *_ip;
    type = 0;
    _class = 0;
...
void DeviceKeyPress(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, KeyClass, _deviceKeyPress);
}

void DeviceKeyRelease(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, KeyClass, _deviceKeyRelease);
}

void DeviceButtonPress(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, ButtonClass, _deviceButtonPress);
}

void DeviceButtonRelease(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, ButtonClass, _deviceButtonRelease);
}

void DeviceMotionNotify(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, ValuatorClass, _deviceMotionNotify);
}

void DeviceFocusIn(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, FocusClass, _deviceFocusIn);
}

void DeviceFocusOut(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, FocusClass, _deviceFocusOut);
}

void ProximityIn(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, ProximityClass, _proximityIn);
}

void ProximityOut(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, ProximityClass, _proximityOut);
}

void DeviceStateNotify(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, OtherClass, _deviceStateNotify);
}

void DeviceMappingNotify(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, OtherClass, _deviceMappingNotify);
}

void ChangeDeviceNotify(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, OtherClass, _changeDeviceNotify);
}

void DevicePropertyNotify(A,B,C)(ref A d, ref B type, ref C _class){
    FindTypeAndClass(d, type, _class, OtherClass, _propertyNotify);
}

void DevicePointerMotionHint(A,B,C)(ref A d, ref B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _devicePointerMotionHint;
}

void DeviceButton1Motion(A,B,C)(ref A d, ref B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceButton1Motion;
}

void DeviceButton2Motion(A,B,C)(ref A d, ref B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceButton2Motion;
}

void DeviceButton3Motion(A,B,C)(ref A d, ref B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceButton3Motion;
}

void DeviceButton4Motion(A,B,C)(A d, B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceButton4Motion;
}

void DeviceButton5Motion(A,B,C)(ref A d, ref B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceButton5Motion;
}

void DeviceButtonMotion(A,B,C)(A d, B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceButtonMotion;
}

void DeviceOwnerGrabButton(A,B,C)(ref A d, ref B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceOwnerGrabButton;
}

void DeviceButtonPressGrab(A,B,C)(ref A d, ref B type, ref C _class){
    _class =  (cast(XDevice *) d).device_id << 8 | _deviceButtonGrab;
}

void NoExtensionEvent(A,B,C)(ref A d, ref B type, ref C _class){
...
void DevicePresence(A,B,C)(A dpy, B type, C _class){
